...
void start_duplicate_file_checker(const char *directory) {
...
#ifdef UNICODE
    MultiByteToWideChar(CP_UTF8, 0, directory, -1, directoryPath, BUF_SIZE);
#else
    strncpy(directoryPath, directory, BUF_SIZE);
#endif
